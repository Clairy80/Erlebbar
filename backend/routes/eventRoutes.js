  ...
  try {
    ...
    res.status(200).json({
      ...
      user: {
        ...
        username: user.username,
        role: user.role,
        accessibilityOptions: user.accessibilityOptions
      }
    });
  } catch (error) {
